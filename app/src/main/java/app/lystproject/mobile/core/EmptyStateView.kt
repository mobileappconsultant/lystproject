package app.lystproject.mobile.core
...
import app.lystproject.mobile.databinding.EmptyStateLayoutBinding

typealias ActionButtonClickListener = () -> Unit

class EmptyStateView : LinearLayout {

    var binding: EmptyStateLayoutBinding
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        binding = EmptyStateLayoutBinding.inflate(inflater, this, true)
